...
det = "BRERIN+WE+AM^2+AG \n\nA Philosobot:\n\nTrained on the diverse SenseLab writings and including collected book-length works of Erin Manning, Brian Massumi, Anna Munster, Andrew Goodman, and Andrew Murphie.\n\n+~+Library: PyTorch+~+\n\nMode: "+style+"\nEmbedding size: "+str(emsize)+"\nHidden Layers: "+str(nhid)+"\nBatch size: "+bs+"\nEpoch: "+ep+"\nLoss: "+loss+"\nPerplexity: "+ppl+"\n\nTemperature range: "+str(MIN_TEMP)+" to "+str(MAX_TEMP)
