...
print("\n"+det)
print ("\nInitializing BURSTY Temperature.\nPlease be patient.\n\n")
...
#total words produced for this poem
total_words_poem=0
total_words_poem_MIN=60
total_words_poem_MAX=100
...
while(True):
    ...
    with open(tfn, 'w') as outf:
        ...
        args.words= random.randint(burst_MIN, burst_MAX)
        print('\n\n',args.words,args.temperature)
